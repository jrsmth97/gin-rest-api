...
type Repository interface {
	ActivationRepository(input *model.UsersEntity) (*model.UsersEntity, string)
}
...
func (r *repository) ActivationRepository(input *model.UsersEntity) (*model.UsersEntity, string) {
